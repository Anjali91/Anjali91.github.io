...
** Open http://www.facebook.com on any net browser .

** Right click on the blank space of the login page, click on ‘view page source’ option.

** A screen filled with codes will appear.

** Now press ctrl+a and copy the whole source to notepad.

** Now press ctrl+f and search for word ‘action’ in the source.

** Replace the selected text written in quotes with ‘post.php’  inthe above image .
...
** Now save the file with ‘.html’ extension. For example : facebook.html

** Copy paste the following script to notepad, edit the contents of 2nd line in the script
...
** Now register to any free web hosting site. For example : www.my3gb.com

** Upload the two files created above, one with .html extension(as per our example : facebook.html) and the other post.php

on your account on free web hosting site.

** If you register on my3gb.com , to see your uploaded files click on ‘file manager’.

** Now right click on file with .html extension(facebook.html) that you uploaded shortly, and select “copy link location”. Then paste the link on the address bar in new tab.

** A page similar to facebook login page will load , but the difference will only be seen in the address bar.
